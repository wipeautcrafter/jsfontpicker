"use strict";var FontPicker=function(){"use strict";var i0=Object.defineProperty,P=t=>{throw TypeError(t)},e0=(t,i,e)=>i in t?i0(t,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[i]=e,r=(t,i,e)=>e0(t,typeof i!="symbol"?i+"":i,e),O=(t,i,e)=>i.has(t)||P("Cannot "+e),C=(t,i,e)=>(O(t,i,"read from private field"),e?e.call(t):i.get(t)),$=(t,i,e)=>i.has(t)?P("Cannot add the same private member more than once"):i instanceof WeakSet?i.add(t):i.set(t,e),N=(t,i,e)=>(O(t,i,"access private method"),e),v,b,T,B,F;const E=`/* FPB */
