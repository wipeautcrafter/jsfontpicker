var FontPicker = function(bootstrap2) {
...
var __privateMethod = (obj, member, method) => (__accessCheck(obj, member, "access private method"), method);
  ...
  const bootstrap__namespace = /* @__PURE__ */ _interopNamespaceDefault(bootstrap2);
  ...
  class PickerDialog {
    constructor(parent) {
      ...
      this.modal = new bootstrap__namespace.Modal(this.$modal, { keyboard: false });
