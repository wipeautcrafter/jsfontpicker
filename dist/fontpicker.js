...
var j = (e, a, i) => a in e ? F(e, a, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[a] = i;
var s = (e, a, i) => j(e, typeof a != "symbol" ? a + "" : a, i), A = (e, a, i) => a.has(e) || M("Cannot " + i);
var w = (e, a, i) => (A(e, a, "read from private field"), i ? i.call(e) : a.get(e)), b = (e, a, i) => a.has(e) ? M("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(e) : a.set(e, i);
var C = (e, a, i) => (A(e, a, "access private method"), i);
import * as G from "bootstrap";
const _ = `<div id="fp__modal" class="modal fade" tabindex="-1">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button id="fp__cancel" type="button" class="btn btn-secondary"></button>
        <button id="fp__pick" type="button" class="btn btn-primary"></button>
      </div>
    </div>
  </div>
</div>
`, R = '<svg xmlns="http://www.w3.org/2000/svg" stroke-width="2" viewBox="0 0 18 18"><path d="M9 2.314 C13.438-2.248 24.534 5.735 9 16-6.534 5.736 4.562-2.248 9 2.314z" /></svg>', E = () => {
  const e = document.createElement("div");
  return e.className = "fp__heart", e.role = "button", e.innerHTML = R, e;
}, D = (e) => {
  const a = document.createElement("div");
  a.className = "px-3 py-1 fp__font-item rounded-pill user-select-none", a.role = "button", a.dataset.family = e.name;
  const i = document.createElement("span");
  return i.className = "fs-6 pe-none", i.textContent = e.name, i.style.fontFamily = `"${e.name}"`, a.append(i, E()), a;
}, $ = (e) => {
  const a = Array.from(new Set(e.map((t) => parseInt(t)))), i = document.createElement("button");
  return i.className = "btn btn-outline-secondary fp__btn-badge", i.dataset.bsToggle = "button", i.textContent = "Italic", i.id = "fp__italic", [
    ...a.flatMap((t) => {
      ...
      return r.className = "btn btn-outline-primary fp__btn-badge", r.htmlFor = n, r.textContent = t.toString(), [l, r];
    }),
    i
  ];
}, K = (e, a) => {
  const i = document.createElement("option");
  return i.value = e, i.textContent = a, i;
}, f = (e) => Object.entries(e).map(([a, i]) => K(a, i)), I = (e, a) => {
  const i = document.createElement("button");
  return i.className = "btn btn-outline-primary fp__btn-badge", i.dataset.value = e, i.dataset.bsToggle = "button", i.textContent = a, i;
}, H = (e) => Object.entries(e).map(([a, i]) => I(a, i)), q = (e, a) => {
  for (const i of e.children) {
    const t = i.dataset.value;
    i.classList.toggle("active", a.includes(t));
  }
}, V = (e) => Array.from(e.querySelectorAll(".active")).map(
  (a) => a.dataset.value
), N = [], P = [];
function U(e, a) {
  if (e === a)
    return 0;
  const i = e;
  e.length > a.length && (e = a, a = i);
  let t = e.length, n = a.length;
  for (; t > 0 && e.charCodeAt(~-t) === a.charCodeAt(~-n); )
    t--, n--;
  let l = 0;
  for (; l < t && e.charCodeAt(l) === a.charCodeAt(l); )
    l++;
  if (t -= l, n -= l, t === 0)
    return n;
  let r, o, c, x, d = 0, h = 0;
  for (; d < t; )
    P[d] = e.charCodeAt(l + d), N[d] = ++d;
  for (; h < n; )
    for (r = a.charCodeAt(l + h), c = h++, o = h, d = 0; d < t; d++)
      x = r === P[d] ? c : c + 1, c = N[d], o = N[d] = c > o ? x > o ? o + 1 : x : x > c ? c + 1 : x;
  return o;
}
const J = (e, a, i) => i === "name" ? e.name.localeCompare(a.name) : i === "popularity" ? e.popularity === void 0 && a.popularity === void 0 ? 0 : e.popularity === void 0 ? 1 / 0 : a.popularity === void 0 ? -1 / 0 : e.popularity - a.popularity : e.metrics === void 0 && a.metrics === void 0 ? 0 : e.metrics === void 0 ? 1 / 0 : a.metrics === void 0 ? -1 / 0 : i === "complexity" ? a.metrics.complexity - e.metrics.complexity : i === "curvature" ? a.metrics.curvature - e.metrics.curvature : i === "thickness" ? a.metrics.thickness - e.metrics.thickness : i === "width" ? a.metrics.width - e.metrics.width : 0, S = (e, a) => a === "all" ? !0 : e === void 0 ? !1 : Math.abs(e - parseFloat(a)) < 0.1, z = (e, a) => {
  var i, t, n, l;
  if (a.name) {
    const r = U(e.name.toLowerCase(), a.name.toLowerCase()), o = [...e.name].length - [...a.name].length;
    if (r > o) return !1;
  }
  return !(a.subset !== "all" && !e.subsets.includes(a.subset) || !a.categories.includes(e.category) || !S((i = e.metrics) == null ? void 0 : i.width, a.width) || !S((t = e.metrics) == null ? void 0 : t.complexity, a.complexity) || !S((n = e.metrics) == null ? void 0 : n.curvature, a.curvature) || !S((l = e.metrics) == null ? void 0 : l.thickness, a.thickness));
}, g = class g {
  constructor(a, i, t) {
    s(this, "family");
    s(this, "weight");
    s(this, "italic");
    this.family = a, this.weight = i, this.italic = t;
  }
  get style() {
  ...
  toString() {
    ...
    return a.push(g.weightNames[this.weight]), this.italic && a.push("Italic"), a.push(`(${this.variant})`), a.join(" ");
  }
  static parse(a, i = a.getDefaultVariant()) {
    const t = parseInt(i), n = i.endsWith("i");
    return new g(a, t, n);
  }
};
s(g, "weightNames", {
...
class v {
  ...
  getDefaultVariant() {
    return Array.from(new Set(this.variants)).toSorted((i, t) => Math.abs(parseInt(i) - 400) - Math.abs(parseInt(t) - 400))[0];
  }
  // parse font family from compressed format
  static parse(a) {
    const [i, t, n, l, r, o, c, x, d] = a.split("/"), h = new v({
      name: i,
      category: t,
      variants: n.split(","),
      subsets: l.split(",")
...
class Q extends HTMLElement {
  ...
  connectedCallback() {
    this.createLayout(), this.modal = new G.Modal(this.$modal), this.observer = new IntersectionObserver((i) => {
      for (const t of i) {
  ...
  filterFamilies(i) {
    const l = this.getFamilies().filter((r) => z(r, i)).map((r) => r.name);
  ...
  updateSort() {
    const i = this.$sort.value, t = this.$sortOrder.classList.contains("active");
    this.sortFamilies(i, t);
  }
  updateFilter() {
    this.filterFamilies({
      name: this.$search.value,
      subset: this.$subset.value,
      categories: V(this.$categories),
  ...
  selectFont(i) {
    ...
    this.$variants.textContent = "", this.$variants.append(...$(i.family.variants));
    const t = this.$variants.querySelector(`[value="${i.weight}"]`), n = this.$variants.querySelector("#fp__italic");
    if (!t) throw new Error("Could not find weight button for selected font.");
    if (!n) throw new Error("Could not find italic button for selected font.");
    t.checked = !0, n.classList.toggle("active", i.italic), this.updateVariant();
  }
  favouriteFont(i) {
  ...
  updateVariant() {
    ...
    const i = this.$variants.querySelector(".fp__weight:checked"), t = this.$variants.querySelector("#fp__italic");
    ...
    let n = parseInt(i.value), l = t.classList.contains("active");
    const r = this.selected.family.variants.includes(`${n}`), o = this.selected.family.variants.includes(`${n}i`);
    t.disabled = !r || !o, r || (l = !0), o || (l = !1), t.classList.toggle("active", l), this.selected.weight = n, this.selected.italic = l, this.updatePreview();
  }
  createFonts() {
    for (const i of this.getFamilies()) {
      const t = D(i);
      this.$fonts.append(t), this.observer.observe(t);
    }
  }
  applyTranslations() {
    const i = Y[this.config.language];
    this.$search.placeholder = i.search, this.querySelector("#fp__title").textContent = i.selectFont, this.$subset.append(...f(i.subsets)), this.$categories.append(...H(i.categories)), this.$width.append(...f(i.widths)), this.$thickness.append(...f(i.thicknesses)), this.$complexity.append(...f(i.complexities)), this.$curvature.append(...f(i.curvatures)), this.$sort.append(...f(i.sorts)), this.$preview.textContent = this.config.previewText ?? i.sampleText, this.$cancelBtn.textContent = i.cancel, this.$pickBtn.textContent = i.select, this.querySelector("#fp__tab-filters").textContent = i.filters, this.querySelector("#fp__tab-metrics").textContent = i.metrics, this.querySelector("#fp__tab-sort").textContent = i.sort;
  }
  onFontHover(i) {
    const t = this.getFamilyFor(i.target);
    t && (t === this.selected.family ? this.hovered = null : this.hovered = y.parse(t), this.updatePreview());
  }
  onFontUnhover(i) {
  ...
  onFontClick(i) {
    const t = i.target;
    if (t.classList.contains("fp__heart")) {
      const l = this.getFamilyFor(t.parentElement);
      if (!l) return;
      const r = y.parse(l);
      this.selectFont(r), this.favouriteFont(r);
      return;
    }
    const n = this.getFamilyFor(t);
    !n || this.selected.family === n || this.selectFont(y.parse(n));
  }
  onFontDoubleClick(i) {
  ...
  bindEvents() {
    ...
    const t = () => this.updateSort();
    this.$sort.addEventListener("input", t), this.$sortOrder.addEventListener("click", t), this.$fonts.addEventListener("mouseover", (n) => this.onFontHover(n)), this.$fonts.addEventListener("mouseout", (n) => this.onFontUnhover(n)), this.$fonts.addEventListener("click", (n) => this.onFontClick(n)), this.$fonts.addEventListener("dblclick", (n) => this.onFontDoubleClick(n)), this.$variants.addEventListener("click", () => this.updateVariant()), this.$pickBtn.addEventListener("click", () => this.submit()), this.$cancelBtn.addEventListener("click", () => this.cancel());
  }
  assignDefaults() {
    q(this.$categories, this.config.defaultCategories), this.$subset.value = this.config.defaultSubset, this.$width.value = this.config.defaultWidth, this.$thickness.value = this.config.defaultThickness, this.$complexity.value = this.config.defaultComplexity, this.$curvature.value = this.config.defaultCurvature, this.$sort.value = this.config.sortBy, this.$sortOrder.classList.toggle("active", this.config.sortReverse), this.picker.favourites.forEach((i) => this.getElementFor(i).classList.add("fp__fav")), this.$variants.classList.toggle("d-none", !this.config.variants);
  }
  async open(i) {
    this.opened || (this.opened = !0, this.picker = i, this.config = this.picker.getConfig(), this.createFonts(), this.applyTranslations(), this.bindEvents(), this.selectFont(i.font), this.assignDefaults(), this.updateSort(), this.updateFilter(), this.modal.show(), this.picker.dispatchEvent(new Event("open")), await new Promise((t) => {
      this.$modal.addEventListener("hidden.bs.modal", () => t());
...
class X extends HTMLButtonElement {
  ...
  configure(i) {
    ...
    (!this.families || t.includes("googleFonts") || t.includes("systemFonts") || t.includes("extraFonts")) && this.updateFamilies(), (!this.font || t.includes("font")) && this.setFont(this._config.font), this.initialized || this.initialize();
  }
  initialize() {
    ...
    if (this._config.saveFavourites) {
      ...
      t && i.push(...JSON.parse(t));
    }
    this._favourites = new Set(i.map((t) => this.getFamily(t)));
  }
  updateFamilies() {
    const i = [
      ...B.filter((t) => {
      ...
      ...this._config.extraFonts.map((t) => new v(t))
    ];
    this._families = /* @__PURE__ */ new Map(), i.forEach((t) => this.families.set(t.name, t));
  }
  getFamily(i) {
    const t = this.families.get(i);
    if (!t) throw new Error(`Could not find font family '${i}'!`);
    return t;
  }
  setFont(i) {
    if (i instanceof y)
      ...
      const [t, n] = i.split(":"), l = this.getFamily(t);
      this._font = y.parse(l, n);
    } else
      this._font = y.parse(i);
  ...
  markFavourite(i, t) {
    if (t === void 0 && (t = !this.favourites.has(i)), t ? this.favourites.add(i) : this.favourites.delete(i), this._config.saveFavourites) {
  ...
  async open() {
    return this.close(), m = document.createElement("font-picker-dialog"), this._config.container.append(m), await m.open(this), m.remove(), m = null, this.font;
  }
  async close() {
    m == null || m.close();
  }
