...
var _ = (t, a, i) => a in t ? F(t, a, { enumerable: !0, configurable: !0, writable: !0, value: i }) : t[a] = i;
var s = (t, a, i) => _(t, typeof a != "symbol" ? a + "" : a, i), A = (t, a, i) => a.has(t) || M("Cannot " + i);
...
import * as j from "bootstrap";
const G = `<div id="fp__modal" class="modal fade" tabindex="-1">
...
`, R = '<svg xmlns="http://www.w3.org/2000/svg" stroke-width="2" viewBox="0 0 18 18"><path d="M9 2.314 C13.438-2.248 24.534 5.735 9 16-6.534 5.736 4.562-2.248 9 2.314z" /></svg>', E = () => {
  ...
  return t.className = "fp__heart", t.role = "button", t.innerHTML = R, t;
}, D = (t) => {
  const a = document.createElement("div");
  a.className = "px-3 py-1 fp__font-item rounded-pill user-select-none", a.role = "button", a.dataset.family = t.name;
  const i = document.createElement("span");
  return i.className = "fs-6 pe-none", i.textContent = t.name, i.style.fontFamily = `"${t.name}"`, a.append(i, E()), a;
}, $ = (t) => {
...
}, y = (t) => Object.entries(t).map(([a, i]) => K(a, i)), I = (t, a) => {
...
}, H = (t) => Object.entries(t).map(([a, i]) => I(a, i)), q = (t, a) => {
  for (const i of t.children) {
    const e = i.dataset.value;
    i.classList.toggle("active", a.includes(e));
  }
}, V = (t) => Array.from(t.querySelectorAll(".active")).map(
  (a) => a.dataset.value
), N = [], B = [];
function z(t, a) {
  if (t === a)
...
`, P = W.split("|").map(v.parse), T = Z.split("|").map(v.parse);
var g, p, O, L;
class k {
  static loaded(a) {
  ...
  static async load(a) {
    let i;
    const e = P.find((l) => l.name === a), n = T.find((l) => l.name === a);
    if (e)
      i = C(this, p, L).call(this, e);
    else throw n ? new Error("System font loading is not implemented yet!") : new Error(`Font '${a}' does not exist!`);
    w(this, g).set(a, i), await i;
  }
}
g = new WeakMap(), p = new WeakSet(), O = async function(a) {
  ...
  i.searchParams.set("family", e), i.searchParams.set("display", "swap"), C(this, p, O).call(this, i.toString()), await document.fonts.load(`1em "${a.name}"`);
...
class Q extends HTMLElement {
  ...
  connectedCallback() {
    this.createLayout(), this.modal = new j.Modal(this.$modal), this.observer = new IntersectionObserver((i) => {
      for (const e of i) {
  ...
  sortFamilies(i, e = !1) {
    const l = this.getFamilies().sort((o, c) => U(o, c, i));
    e && l.reverse();
    for (const o of l)
  ...
  filterFamilies(i) {
    const l = this.getFamilies().filter((r) => J(r, i)).map((r) => r.name);
