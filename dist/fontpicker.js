...
var r = (a, i, e) => W(a, typeof i != "symbol" ? i + "" : i, e), B = (a, i, e) => i.has(a) || T("Cannot " + e);
var M = (a, i, e) => (B(a, i, "read from private field"), e ? e.call(a) : i.get(a)), L = (a, i, e) => i.has(a) ? T("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(a) : i.set(a, e);
var A = (a, i, e) => (B(a, i, "access private method"), e);
import * as Z from "bootstrap";
function J(a) {
  return a && a.__esModule && Object.prototype.hasOwnProperty.call(a, "default") ? a.default : a;
}
var O = { exports: {} }, p = typeof Reflect == "object" ? Reflect : null, _ = p && typeof p.apply == "function" ? p.apply : function(i, e, t) {
...
c.prototype.emit = function(i) {
  ...
  if (typeof d == "function")
    ...
    for (var x = d.length, f = I(d, x), t = 0; t < x; ++t)
      _(f[t], this, e);
  return !0;
};
function R(a, i, e, t) {
...
}, x0 = (a) => Object.entries(a).map(([i, e]) => f0(i, e)), h0 = (a, i) => {
...
class k {
  ...
  static parse(i) {
    const [e, t, n, l, s, o, d, x, f] = i.split("/"), h = new k({
      name: e,
      category: t,
      variants: n.split(","),
      subsets: l.split(",")
    });
    return s && (h.popularity = parseInt(s)), o && d && x && f && (h.metrics = {
      width: parseFloat(o),
...
class w0 {
  ...
  createLayout(i) {
    i.insertAdjacentHTML("afterend", l0), this.$modal = document.querySelector("#fp__modal"), this.$search = this.$modal.querySelector("#fp__search"), this.$subset = this.$modal.querySelector("#fp__subsets"), this.$categories = this.$modal.querySelector("#fp__categories"), this.$width = this.$modal.querySelector("#fp__width"), this.$thickness = this.$modal.querySelector("#fp__thickness"), this.$complexity = this.$modal.querySelector("#fp__complexity"), this.$curvature = this.$modal.querySelector("#fp__curvature"), this.$sort = this.$modal.querySelector("#fp__sort"), this.$sortOrder = this.$modal.querySelector("#fp__sort-order"), this.$preview = this.$modal.querySelector("#fp__preview"), this.$fonts = this.$modal.querySelector("#fp__fonts"), this.$variants = this.$modal.querySelector("#fp__variants"), this.$cancelBtn = this.$modal.querySelector("#fp__cancel"), this.$pickBtn = this.$modal.querySelector("#fp__pick");
  }
  getElementFor(i) {
  ...
  applyTranslations() {
    const i = k0[this.config.language];
    this.$search.placeholder = i.search, this.$modal.querySelector("#fp__title").textContent = i.selectFont, this.$subset.append(...y(i.subsets)), this.$categories.append(...x0(i.categories)), this.$width.append(...y(i.widths)), this.$thickness.append(...y(i.thicknesses)), this.$complexity.append(...y(i.complexities)), this.$curvature.append(...y(i.curvatures)), this.$sort.append(...y(i.sorts)), this.$preview.textContent = this.config.previewText ?? i.sampleText, this.$modal.querySelector("#fp__t-filters").textContent = i.filters, this.$modal.querySelector("#fp__t-metrics").textContent = i.metrics, this.$modal.querySelector("#fp__t-sort").textContent = i.sort, this.$modal.querySelector("#fp__t-cancel").textContent = i.cancel, this.$modal.querySelector("#fp__t-pick").textContent = i.select;
  }
  onFontHover(i) {
  ...
  assignDefaults() {
    h0(this.$categories, this.config.defaultCategories), this.$subset.value = this.config.defaultSubset, this.$width.value = this.config.defaultWidth, this.$thickness.value = this.config.defaultThickness, this.$complexity.value = this.config.defaultComplexity, this.$curvature.value = this.config.defaultCurvature, this.$sort.value = this.config.sortBy, this.$sortOrder.classList.toggle("active", this.config.sortReverse), this.picker.favourites.forEach((i) => this.getElementFor(i).classList.add("fp__fav")), this.$variants.classList.toggle("d-none", !this.config.variants);
  }
  async open(i) {
    this.opened || (this.opened = !0, this.picker = i, this.config = this.picker.getConfig(), this.applyTranslations(), this.bindEvents(), this.modal.show(), this.createFonts(), this.selectFont(i.font), this.assignDefaults(), this.updateSort(), this.updateFilter(), this.picker.emit("open"), await new Promise((e) => {
...
class C0 extends n0 {
  ...
  updateFamilies() {
    const e = [
      ...
      ...this._config.extraFonts.map((t) => new k(t))
    ];
