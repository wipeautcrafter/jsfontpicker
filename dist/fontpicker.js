...
var W = (a, i, e) => i in a ? z(a, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[i] = e;
var r = (a, i, e) => W(a, typeof i != "symbol" ? i + "" : i, e), T = (a, i, e) => i.has(a) || _("Cannot " + e);
var M = (a, i, e) => (T(a, i, "read from private field"), e ? e.call(a) : i.get(a)), L = (a, i, e) => i.has(a) ? _("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(a) : i.set(a, e);
var A = (a, i, e) => (T(a, i, "access private method"), e);
import * as Z from "bootstrap";
function J(a) {
  return a && a.__esModule && Object.prototype.hasOwnProperty.call(a, "default") ? a.default : a;
}
var O = { exports: {} }, p = typeof Reflect == "object" ? Reflect : null, B = p && typeof p.apply == "function" ? p.apply : function(i, e, t) {
  return Function.prototype.apply.call(i, e, t);
}, b;
p && typeof p.ownKeys == "function" ? b = p.ownKeys : Object.getOwnPropertySymbols ? b = function(i) {
...
c.prototype.emit = function(i) {
  ...
  if (typeof d == "function")
    ...
    for (var h = d.length, f = I(d, h), t = 0; t < h; ++t)
      B(f[t], this, e);
  return !0;
};
function R(a, i, e, t) {
  var n, l, s;
  if (N(e), l = a._events, l === void 0 ? (l = a._events = /* @__PURE__ */ Object.create(null), a._eventsCount = 0) : (l.newListener !== void 0 && (a.emit(
    "newListener",
    i,
...
c.prototype.addListener = function(i, e) {
  return R(this, i, e, !1);
};
c.prototype.on = c.prototype.addListener;
c.prototype.prependListener = function(i, e) {
  return R(this, i, e, !0);
};
function Q() {
  if (!this.fired)
...
function G(a, i, e) {
  var t = { fired: !1, wrapFn: void 0, target: a, type: i, listener: e }, n = Q.bind(t);
  return n.listener = e, t.wrapFn = n, n;
}
c.prototype.once = function(i, e) {
  return N(e), this.on(i, G(this, i, e)), this;
};
c.prototype.prependOnceListener = function(i, e) {
  return N(e), this.prependListener(i, G(this, i, e)), this;
};
c.prototype.removeListener = function(i, e) {
  var t, n, l, s, o;
  if (N(e), n = this._events, n === void 0)
    return this;
  if (t = n[i], t === void 0)
    return this;
  if (t === e || t.listener === e)
    --this._eventsCount === 0 ? this._events = /* @__PURE__ */ Object.create(null) : (delete n[i], n.removeListener && this.emit("removeListener", i, t.listener || e));
  else if (typeof t != "function") {
    for (l = -1, s = t.length - 1; s >= 0; s--)
    ...
    if (l < 0)
      return this;
    l === 0 ? t.shift() : X(t, l), t.length === 1 && (n[i] = t[0]), n.removeListener !== void 0 && this.emit("removeListener", i, o || e);
  }
  return this;
};
...
c.prototype.removeAllListeners = function(i) {
  ...
  if (t.removeListener === void 0)
    return arguments.length === 0 ? (this._events = /* @__PURE__ */ Object.create(null), this._eventsCount = 0) : t[i] !== void 0 && (--this._eventsCount === 0 ? this._events = /* @__PURE__ */ Object.create(null) : delete t[i]), this;
  if (arguments.length === 0) {
    var l = Object.keys(t), s;
    for (n = 0; n < l.length; ++n)
      s = l[n], s !== "removeListener" && this.removeAllListeners(s);
    return this.removeAllListeners("removeListener"), this._events = /* @__PURE__ */ Object.create(null), this._eventsCount = 0, this;
  }
  if (e = t[i], typeof e == "function")
    this.removeListener(i, e);
  else if (e !== void 0)
    for (n = e.length - 1; n >= 0; n--)
      this.removeListener(i, e[n]);
  return this;
};
function D(a, i, e) {
  var t = a._events;
  if (t === void 0)
    return [];
  var n = t[i];
  return n === void 0 ? [] : typeof n == "function" ? e ? [n.listener || n] : [n] : e ? i0(n) : I(n, n.length);
}
...
c.listenerCount = function(a, i) {
  return typeof a.listenerCount == "function" ? a.listenerCount(i) : K.call(a, i);
};
...
function i0(a) {
  for (var i = new Array(a.length), e = 0; e < i.length; ++e)
    i[e] = a[e].listener || a[e];
  return i;
}
function e0(a, i) {
  return new Promise(function(e, t) {
    function n(s) {
      a.removeListener(i, l), t(s);
    }
    function l() {
      typeof a.removeListener == "function" && a.removeListener("error", n), e([].slice.call(arguments));
    }
    H(a, i, l, { once: !0 }), i !== "error" && a0(a, n, { once: !0 });
  });
}
function a0(a, i, e) {
  typeof a.on == "function" && H(a, "error", i, e);
}
function H(a, i, e, t) {
  if (typeof a.on == "function")
    t.once ? a.once(i, e) : a.on(i, e);
  else if (typeof a.addEventListener == "function")
    a.addEventListener(i, function n(l) {
      t.once && a.removeEventListener(i, n), e(l);
    });
  else
    throw new TypeError('The "emitter" argument must be of type EventEmitter. Received type ' + typeof a);
}
var t0 = O.exports;
const n0 = /* @__PURE__ */ J(t0), l0 = `<div id="fp__modal" class="modal fade" tabindex="-1">
      ...
      <div class="modal-footer">
        <div class="d-flex flex-grow-1">
          <button
            id="fp__clear"
            type="button"
            class="btn btn-link link-warning text-decoration-none rounded-pill fp__has-icon"
          >
            <!-- prettier-ignore -->
...
`, s0 = '<svg xmlns="http://www.w3.org/2000/svg" stroke-width="2" viewBox="0 0 18 18"><path d="M9 2.314 C13.438-2.248 24.534 5.735 9 16-6.534 5.736 4.562-2.248 9 2.314z" /></svg>', r0 = () => {
  const a = document.createElement("div");
  return a.className = "fp__heart", a.role = "button", a.innerHTML = s0, a;
}, o0 = (a) => {
  const i = document.createElement("div");
  i.className = "px-3 py-1 fp__font-item rounded-pill user-select-none", i.role = "button", i.dataset.family = a.name;
  const e = document.createElement("span");
  return e.className = "fs-6 pe-none", e.textContent = a.name, e.style.fontFamily = `"${a.name}"`, i.append(e, r0()), i;
}, c0 = (a) => {
  const i = Array.from(new Set(a.map((t) => parseInt(t)))), e = document.createElement("button");
  return e.className = "btn btn-outline-warning fp__btn-badge", e.dataset.bsToggle = "button", e.textContent = "Italic", e.id = "fp__italic", [
    ...i.flatMap((t) => {
      const n = `fp__weight-${t}`, l = document.createElement("input");
      l.type = "radio", l.className = "btn-check fp__weight", l.value = t.toString(), l.id = n, l.name = "fp__weight";
      const s = document.createElement("label");
      return s.className = "btn btn-outline-primary fp__btn-badge", s.htmlFor = n, s.textContent = t.toString(), [l, s];
    }),
    e
  ];
}, d0 = (a, i) => {
  const e = document.createElement("option");
  return e.value = a, e.textContent = i, e;
}, y = (a) => Object.entries(a).map(([i, e]) => d0(i, e)), f0 = (a, i) => {
  const e = document.createElement("button");
  return e.className = "btn btn-outline-primary fp__btn-badge", e.dataset.value = a, e.dataset.bsToggle = "button", e.textContent = i, e;
}, h0 = (a) => Object.entries(a).map(([i, e]) => f0(i, e)), x0 = (a, i) => {
  for (const e of a.children) {
    const t = e.dataset.value;
    e.classList.toggle("active", i.includes(t));
  }
}, m0 = (a) => Array.from(a.querySelectorAll(".active")).map(
  (i) => i.dataset.value
), P = [], j = [];
function y0(a, i) {
  if (a === i)
    return 0;
  const e = a;
  a.length > i.length && (a = i, i = e);
  let t = a.length, n = i.length;
  for (; t > 0 && a.charCodeAt(~-t) === i.charCodeAt(~-n); )
    t--, n--;
  let l = 0;
  for (; l < t && a.charCodeAt(l) === i.charCodeAt(l); )
    l++;
  if (t -= l, n -= l, t === 0)
    return n;
  let s, o, d, h, f = 0, x = 0;
  for (; f < t; )
    j[f] = a.charCodeAt(l + f), P[f] = ++f;
  for (; x < n; )
    for (s = i.charCodeAt(l + x), d = x++, o = x, f = 0; f < t; f++)
      h = s === j[f] ? d : d + 1, d = P[f], o = P[f] = d > o ? h > o ? o + 1 : h : h > d ? d + 1 : h;
  return o;
}
const u0 = (a, i, e) => e === "name" ? a.name.localeCompare(i.name) : e === "popularity" ? a.popularity === void 0 && i.popularity === void 0 ? 0 : a.popularity === void 0 ? 1 / 0 : i.popularity === void 0 ? -1 / 0 : a.popularity - i.popularity : a.metrics === void 0 && i.metrics === void 0 ? 0 : a.metrics === void 0 ? 1 / 0 : i.metrics === void 0 ? -1 / 0 : e === "complexity" ? i.metrics.complexity - a.metrics.complexity : e === "curvature" ? i.metrics.curvature - a.metrics.curvature : e === "thickness" ? i.metrics.thickness - a.metrics.thickness : e === "width" ? i.metrics.width - a.metrics.width : 0, w = (a, i) => i === "all" ? !0 : a === void 0 ? !1 : a === parseFloat(i), p0 = (a, i) => {
  var e, t, n, l;
  if (i.name) {
    const s = y0(a.name.toLowerCase(), i.name.toLowerCase()), o = [...a.name].length - [...i.name].length;
    if (s > o) return !1;
  }
  return !(a.subsets && i.subset !== "all" && !a.subsets.includes(i.subset) || a.category && !i.categories.includes(a.category) || !w((e = a.metrics) == null ? void 0 : e.width, i.width) || !w((t = a.metrics) == null ? void 0 : t.complexity, i.complexity) || !w((n = a.metrics) == null ? void 0 : n.curvature, i.curvature) || !w((l = a.metrics) == null ? void 0 : l.thickness, i.thickness));
}, v = class v {
  constructor(i, e, t) {
    r(this, "family");
    r(this, "weight");
    r(this, "italic");
    this.family = i, this.weight = e, this.italic = t;
  }
  get style() {
  ...
  toString() {
    ...
    const i = [this.family.name];
    return i.push(v.weightNames[this.weight]), this.italic && i.push("Italic"), i.push(`(${this.variant})`), i.join(" ");
  }
  static parse(i, e = i.getDefaultVariant()) {
    const t = parseInt(e), n = e.endsWith("i");
    return new v(i, t, n);
  }
};
r(v, "weightNames", {
...
class w0 {
  constructor(i) {
    ...
    r(this, "$cancelBtn");
    r(this, "$pickBtn");
    this.createLayout(i), this.modal = new Z.Modal(this.$modal, { keyboard: !1 }), this.observer = new IntersectionObserver((e) => {
      for (const t of e) {
        if (t.intersectionRatio <= 0) return;
        const n = t.target, l = n.dataset.family;
        l && C.load(l), this.observer.unobserve(n);
      }
    });
  }
  createLayout(i) {
    i.insertAdjacentHTML("afterend", l0), this.$modal = document.querySelector("#fp__modal"), this.$search = this.$modal.querySelector("#fp__search"), this.$subset = this.$modal.querySelector("#fp__subsets"), this.$categories = this.$modal.querySelector("#fp__categories"), this.$width = this.$modal.querySelector("#fp__width"), this.$thickness = this.$modal.querySelector("#fp__thickness"), this.$complexity = this.$modal.querySelector("#fp__complexity"), this.$curvature = this.$modal.querySelector("#fp__curvature"), this.$sort = this.$modal.querySelector("#fp__sort"), this.$sortOrder = this.$modal.querySelector("#fp__sort-order"), this.$preview = this.$modal.querySelector("#fp__preview"), this.$fonts = this.$modal.querySelector("#fp__fonts"), this.$variants = this.$modal.querySelector("#fp__variants"), this.$clearBtn = this.$modal.querySelector("#fp__clear"), this.$cancelBtn = this.$modal.querySelector("#fp__cancel"), this.$pickBtn = this.$modal.querySelector("#fp__pick");
  }
  getElementFor(i) {
  ...
  sortFamilies(i, e = !1) {
    const n = this.getFamilies().sort((s, o) => u0(s, o, i));
    e && n.reverse();
    for (const s of n)
      this.$fonts.append(this.getElementFor(s));
    for (const s of this.picker.favourites) {
      const o = this.getElementFor(s);
      this.$fonts.prepend(o);
    }
    const l = this.getElementFor(this.selected.family);
    this.$fonts.prepend(l), this.$fonts.scrollTop = 0;
  }
  filterFamilies(i) {
    const n = this.getFamilies().filter((l) => p0(l, i)).map((l) => l.name);
    for (const l of this.$fonts.children) {
      const s = l.dataset.family, o = !n.includes(s);
      l.classList.toggle("d-none", o);
    }
  }
  updateSort() {
  ...
  selectFont(i) {
    for (const n of this.$fonts.querySelectorAll(".fp__selected"))
      n.classList.remove("fp__selected");
    if (this.selected = i, this.getElementFor(i.family).classList.add("fp__selected"), !this.config.variants) return;
    this.$variants.textContent = "", this.$variants.append(...c0(i.family.variants));
    const e = this.$variants.querySelector(`[value="${i.weight}"]`), t = this.$variants.querySelector("#fp__italic");
    if (!e) throw new Error("Could not find weight button for selected font.");
    if (!t) throw new Error("Could not find italic button for selected font.");
    e.checked = !0, t.classList.toggle("active", i.italic), this.updateVariant();
  }
  favouriteFont(i) {
    const t = this.getElementFor(i.family).classList.toggle("fp__fav");
    this.picker.markFavourite(i.family, t), this.updateSort();
  }
  updateVariant() {
    ...
    let t = parseInt(i.value), n = e.classList.contains("active");
    const l = this.selected.family.variants.includes(`${t}`), s = this.selected.family.variants.includes(`${t}i`);
    e.disabled = !l || !s, l || (n = !0), s || (n = !1), e.classList.toggle("active", n), this.selected.weight = t, this.selected.italic = n, this.updatePreview();
  }
  createFonts() {
  ...
  applyTranslations() {
    const i = S0[this.config.language];
    this.$search.placeholder = i.search, this.$modal.querySelector("#fp__title").textContent = i.selectFont, this.$subset.append(...y(i.subsets)), this.$categories.append(...h0(i.categories)), this.$width.append(...y(i.widths)), this.$thickness.append(...y(i.thicknesses)), this.$complexity.append(...y(i.complexities)), this.$curvature.append(...y(i.curvatures)), this.$sort.append(...y(i.sorts)), this.$preview.textContent = this.config.previewText ?? i.sampleText, this.$modal.querySelector("#fp__t-filters").textContent = i.filters, this.$modal.querySelector("#fp__t-metrics").textContent = i.metrics, this.$modal.querySelector("#fp__t-sort").textContent = i.sort, this.$modal.querySelector("#fp__t-clear").textContent = i.clear, this.$modal.querySelector("#fp__t-cancel").textContent = i.cancel, this.$modal.querySelector("#fp__t-pick").textContent = i.select;
  }
  onFontHover(i) {
  ...
  onFontClick(i) {
    ...
    if (e.classList.contains("fp__heart")) {
      const n = this.getFamilyFor(e.parentElement);
      if (!n) return;
      const l = m.parse(n);
      this.selectFont(l), this.favouriteFont(l);
      return;
    }
    const t = this.getFamilyFor(e);
    !t || this.selected.family === t || this.selectFont(m.parse(t));
  }
  onFontDoubleClick(i) {
    this.getFamilyFor(i.target) && this.submit();
  }
  selectClosestFont(i, e, t) {
    let n = t || this.getElementFor(this.selected.family);
    for (; i || n.classList.contains("d-none"); ) {
      i = !1;
      const l = e ? n.previousElementSibling : n.nextElementSibling;
      if (!l) return;
      n = l;
    }
    n.click(), n.scrollIntoView({
      behavior: "instant",
      block: "center"
    });
  }
  selectClosestVariant(i) {
    var l, s;
    const e = this.$variants.querySelector(".fp__weight:checked"), t = i ? (l = e == null ? void 0 : e.previousElementSibling) == null ? void 0 : l.previousElementSibling : (s = e == null ? void 0 : e.nextElementSibling) == null ? void 0 : s.nextElementSibling;
    if (!t) return;
    const n = t;
    n.checked = !0, this.updateVariant();
  }
  toggleVariantItalic() {
  ...
  bindEvents() {
    ...
    const e = () => {
      this.filtersChanged(), this.updateSort();
    };
    this.$sort.addEventListener("input", e), this.$sortOrder.addEventListener("click", e), this.$fonts.addEventListener("mouseover", (t) => this.onFontHover(t)), this.$fonts.addEventListener("mouseout", (t) => this.onFontUnhover(t)), this.$fonts.addEventListener("click", (t) => this.onFontClick(t)), this.$fonts.addEventListener("dblclick", (t) => this.onFontDoubleClick(t)), this.$variants.addEventListener("input", () => this.updateVariant()), this.$variants.addEventListener("click", () => this.updateVariant()), this.$clearBtn.addEventListener("click", () => this.assignDefaults()), this.$pickBtn.addEventListener("click", () => this.submit()), this.$cancelBtn.addEventListener("click", () => this.cancel()), this.$modal.addEventListener("keydown", (t) => this.onKeyPressed(t));
  }
  applyConfiguration() {
    this.picker.favourites.forEach((i) => this.getElementFor(i).classList.add("fp__fav")), this.$variants.classList.toggle("d-none", !this.config.variants);
  }
  filtersChanged(i = !0) {
    this.$clearBtn.classList.toggle("d-none", !i);
  }
  assignDefaults() {
    x0(this.$categories, this.config.defaultCategories), this.$search.value = "", this.$subset.value = this.config.defaultSubset, this.$width.value = this.config.defaultWidth, this.$thickness.value = this.config.defaultThickness, this.$complexity.value = this.config.defaultComplexity, this.$curvature.value = this.config.defaultCurvature, this.$sort.value = this.config.sortBy, this.$sortOrder.classList.toggle("active", this.config.sortReverse), this.updateSort(), this.updateFilter(), this.filtersChanged(!1);
  }
  async open(i) {
    this.opened || (this.opened = !0, this.picker = i, this.config = this.picker.getConfig(), this.applyTranslations(), this.bindEvents(), this.modal.show(), this.createFonts(), this.selectFont(i.font), this.applyConfiguration(), this.assignDefaults(), this.picker.emit("open"), await new Promise((e) => {
      this.$modal.addEventListener("shown.bs.modal", () => this.$modal.focus()), this.$modal.addEventListener("hidden.bs.modal", () => e());
    }), this.picker.emit("close"), this.$modal.remove());
  }
  submit() {
    this.picker.setFont(this.selected), this.picker.emit("pick", this.selected), this.close();
  }
  cancel() {
    this.picker.emit("cancel"), this.close();
  }
  close() {
...
class C0 extends n0 {
  constructor(e, t = {}) {
    ...
    this.$el = e, this.$el.classList.add("font-picker", "form-select"), this.$el.addEventListener("click", this.open.bind(this)), this.configure(t), this.initialize();
  }
  get font() {
    return this._font;
  }
  ...
  configure(e) {
    ...
    (!this.families || t.includes("googleFonts") || t.includes("systemFonts") || t.includes("extraFonts")) && this.updateFamilies(), (!this.font || t.includes("font")) && this.setFont(this._config.font);
  }
  initialize() {
    const e = this._config.favourites.slice();
    if (this._config.saveFavourites) {
      const t = localStorage.getItem(this._config.storageKey);
      t && e.push(...JSON.parse(t));
    }
    this._favourites = /* @__PURE__ */ new Set();
    for (const t of e)
      try {
        const n = this.getFamily(t);
        this._favourites.add(n);
      } catch {
        console.warn(`Font from favourites is not available: '${t}'!`);
      }
  }
  updateFamilies() {
    const e = [
      ...q.filter((t) => {
        var n;
        return ((n = this._config.googleFonts) == null ? void 0 : n.includes(t.name)) ?? !0;
      }),
      ...k0.filter((t) => {
        var n;
        return ((n = this._config.systemFonts) == null ? void 0 : n.includes(t.name)) ?? !0;
      }),
      ...this._config.extraFonts.map((t) => new S(t))
    ];
    this._families = /* @__PURE__ */ new Map(), e.forEach((t) => this.families.set(t.name, t));
  }
  getFamily(e) {
    const t = this.families.get(e);
    if (!t) throw new Error(`Could not find font family '${e}'!`);
    return t;
  }
  setFont(e) {
    if (e instanceof m)
      ...
      const [t, n] = e.split(":"), l = this.getFamily(t);
  ...
  async open() {
    return this.close(), u = new w0(this._config.container), await u.open(this), u = null, this.font;
  }
  async close() {
    u == null || u.close();
  }
